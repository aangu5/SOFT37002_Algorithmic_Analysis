...
// Using a class to allow for testing in other files
...
public:
    static std::string solveTheWall(std::string filename) {
        ...
        std::unordered_map<std::string, std::string> bricksForwards;
        std::unordered_map<std::string, std::string> bricksBackwards;
        ...
        std::unordered_map<std::string, std::string>::const_iterator found = bricksForwards.find(currentBrick.second);
